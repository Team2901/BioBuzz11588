...
public abstract class DynamicMecanumBase extends VirtualBot {
    ...
    public void initialize(){
        ...
        motors = new DcMotorExDynImpl[]{
                (DcMotorExDynImpl) hardwareMap.get(DcMotorEx.class, "backLeft"),
                (DcMotorExDynImpl) hardwareMap.get(DcMotorEx.class, "frontLeft"),
                (DcMotorExDynImpl) hardwareMap.get(DcMotorEx.class, "frontRight"),
                (DcMotorExDynImpl) hardwareMap.get(DcMotorEx.class, "backRight")
        };
