...
public abstract class SquareOmniPhysicsBase extends VirtualBot {
    ...
    public void initialize(){
        ...
        motors = new DcMotorExImpl[]{
                (DcMotorExImpl) hardwareMap.get(DcMotorEx.class, "leftDrive"),
                (DcMotorExImpl) hardwareMap.get(DcMotorEx.class, "rightDrive"),
    ...
    protected void createHardwareMap() {
        ...
        String[] motorNames = new String[]{"leftDrive", "rightDrive", "front_motor", "back_motor"};
        for (int i=0; i<4; i++){
